...
cityTeam(T):- member(T,[1,2,3,4]).

eachRoundTwoHomeTwoAwayOf1234:-
	cityTeam(T1), cityTeam(T2), cityTeam(T3), cityTeam(T4),
	T1 \= T2, T1 \= T3, T1 \= T4,
	T2 \= T3, T2 \= T4,
	T3 \= T4, 
	round(R),
	writeClause([\+home-T1-R, \+home-T2-R, \+home-T3-R]), 
	writeClause([\+home-T1-R, \+home-T2-R, \+home-T4-R]), 
	fail.
eachRoundTwoHomeTwoAwayOf1234.
