...
writeClauses:-
	...
	incompatiblesNoSameTeam,
	eachTeamAtLeastKMinWorkers,
	eachTeamAtMostKMaxWorkers,
    true.
    
eachWorkerExactlyOneTeam:- worker(W),
						   findall(wt-W-T,team(T),Lits),
						   exactly(1,Lits),
						   fail.
eachWorkerExactlyOneTeam.

incompatiblesNoSameTeam:- worker(W1),worker(W2),
						  W1 \= W2,
						  incompatibles(W1,W2),
						  team(T),
...
eachTeamAtLeastKMinWorkers:- minSize(K),
							 team(T),
...
eachTeamAtMostKMaxWorkers:-  maxSize(K),
							 team(T),
							 findall(wt-W-T, worker(W), Lits),
							 atMost(K,Lits),
							 fail.
