...
writeClauses:-
	...
	incompatiblesNoSameGroup,
	eachGroupAtLeastKMinStudents,
	eachGroupAtMostKMaxStudents,
    true.



eachStudentExactlyOneGroup:-student(S),
...
eachGroupAtLeastKMinStudents:- minGroup(K),
							 group(G),
...
eachGroupAtMostKMaxStudents:-  maxGroup(K),
							 group(G),
							 findall(sg-S-G, student(S), Lits),
							 atMost(K,Lits),
							 fail.
