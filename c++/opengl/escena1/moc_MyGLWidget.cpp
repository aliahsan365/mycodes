...
QT_MOC_LITERAL(1, 11, 11), // "sliderValue"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 9), // "changeFOV"
QT_MOC_LITERAL(4, 34, 1) // "x"

    },
    "MyGLWidget\0sliderValue\0\0changeFOV\0x"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGLWidget::sliderValue)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::sliderValue(int _t1)
{
